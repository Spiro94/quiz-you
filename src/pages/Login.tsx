...
// Left panel feature list — exact text from quiz-you.pen loginFeatures
const features = [
  {
...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-background flex">
      {/* Left branding panel — quiz-you.pen: loginLeft, w-680, bg-surface, padding [64, 72], gap-32, justifyContent center */}
      <div
        className="hidden lg:flex lg:w-[680px] shrink-0 flex-col justify-center bg-surface"
        style={{ padding: '64px 72px', gap: '32px' }}
      >
        {/* Logo — quiz-you.pen: loginLeftLogo, gap 10, alignItems center */}
        ...
        {/* Headline — quiz-you.pen: loginHeadline, fontSize 44, fontWeight 800, letterSpacing -1, lineHeight 1.15, fill foreground */}
        <h2
        ...
        {/* Subtext — quiz-you.pen: loginSubtext, fontSize 16, fontWeight normal, lineHeight 1.6, fill muted-foreground */}
        <p
        ...
        {/* Features — quiz-you.pen: loginFeatures, layout vertical, gap 16 */}
        <div className="flex flex-col" style={{ gap: '16px' }}>
          {features.map(({ icon, text }) => (
            // Each feat row: gap 12, alignItems center
      ...
      {/* Right form panel — quiz-you.pen: loginRight, fill_container, padding 48, justifyContent center, alignItems center */}
      <div className="flex flex-1 flex-col items-center justify-center" style={{ padding: '48px' }}>
        ...
        {/* Auth card — quiz-you.pen: authCard, w-440, bg-surface, cornerRadius 16, border border, padding 40, gap 24 */}
